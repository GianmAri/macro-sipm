...
void multifit(TString fname, TString tname){
    ...
    TCanvas *c0=new TCanvas();
        TF1 *g0 = new TF1("g0", "gaus", (0.01e-9), (0.03e-9));
        TF1 *g1 = new TF1("g1", "gaus", (0.03e-9), (0.06e-9));
   ...
   // g->Fit("pol1");
    ...
    gain= (a1-a0)/(1,60e-13);
    Double_t realgain=gain/pow(10,32./20.);
    fstream filegain;
    filegain.open("gain.txt",fstream::app);
    filegain<< realgain<<endl;
    filegain.close();
    cout<<"Il valore di gain per questo dataset "<<realgain<<endl;
